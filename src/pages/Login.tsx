  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#0F172A] p-4 font-sans text-slate-200">
      <div className="max-w-md w-full bg-[#1E293B] rounded-3xl shadow-2xl p-8 border border-slate-800">
        <h2 className="text-3xl font-serif italic text-slate-100 mb-6 text-center">MediFlow Sign In</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button type="submit" className="w-full bg-sky-500 text-slate-900 rounded-full py-3 text-sm font-bold shadow-lg shadow-sky-500/20 hover:bg-sky-400 transition-colors mt-6">Sign In</button>
        </form>
        <p className="mt-6 text-center text-sm text-slate-400">
          Don't have an account? <Link to="/register" className="text-sky-400 hover:text-sky-300 transition-colors">Register here</Link>
        </p>
      </div>
    </div>
  );
